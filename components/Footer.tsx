      ...
      <div className="max-w-7xl px-0 lg:px-5 mx-auto">
        <div className="grid grid-cols-12 gap-6 lg:gap-8 md:mb-5 lg:mb-6">
          ...
          <div className="col-span-12 md:col-span-3 lg:col-span-3 lg:col-start-11">
            ...
            <ul className="space-y-4 text-sm text-gray-300">
              <li><Link href="/what-is-homeopathy" className="text-[#C4C7C1] font-[600] hover:text-[#fff] transition-all duration-500">What is Homeopathy?</Link></li>
              <li><Link href="/safety-and-research" className="text-[#C4C7C1] font-[600] hover:text-[#fff] transition-all duration-500">Safety & Research</Link></li>
        ...
        <div className="border-t border-[#A7ACA1] mt-5 pt-5 flex flex-col md:flex-row justify-between flex-col-reverse items-start lg:items-center gap-4">
          <p className="text-[12px] text-[#D3D6D1] font-[500]">© {new Date().getFullYear()} HomeoPathway. All Rights Reserved.</p>
