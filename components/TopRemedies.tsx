...
export default function TopRemedies({
  remedies,
  ailmentSlug,
}: TopRemediesProps) {
  ...
  return (
    <div className="">
            ...
            <div className="bg-white rounded-xl p-4 sm:p-6 hover:shadow-lg transition-all duration-300 cursor-pointer border border-transparent hover:border-gray-200 mb-[10px]">
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:gap-6">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex flex-row justify-between gap-1 sm:flex-row sm:items-start sm:justify-between mb-2">
                    <div>
                      <h3 className="text-lg sm:text-xl text-[#0B0C0A] font-semibold text-montserrat break-words">
                        {remedy.name}
                      </h3>
                      <p className="text-sm sm:text-base font-medium text-[#2B2E28] break-words">
                        {remedy.indication}
                      </p>
                    </div>
                  ...
                  {/* Description */}
                  <p className="text-xs sm:text-sm text-gray-700 leading-relaxed line-clamp-2 font-medium break-words">
                    {remedy.description}
                  </p>
                </div>
              </div>
      ...
      <div className="flex justify-center mt-6 sm:mt-8 px-2">
        <Link
          href="/remedies"
          className="inline-block bg-[#6C7463] text-white px-6 sm:px-20 py-3 font-[600] rounded-full hover:bg-[#565D4F] transition-colors cursor-pointer duration-500 text-base sm:text-lg"
        >
          View All Remedies
        </Link>
      </div>
