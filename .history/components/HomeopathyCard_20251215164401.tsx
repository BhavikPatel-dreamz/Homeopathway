      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="bg-white p-6 md:p-10 lg:p-12 shadow-xl rounded-lg border border-[#EDECE7]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-10">
            {/* Left Column Content (A historical foundation, natural sources, potentization) */}
            <div className="space-y-10 order-2 lg:order-1">
              ...
              {/* Used worldwide / Non toxic and gentle - Visible on small screens */}
            ...
            <div className="space-y-10 order-1 lg:order-2">
              ...
              {/* Used worldwide - Only visible on large screens */}
              ...
              {/* Non toxic and gentle - Only visible on large screens */}
              <div className='hidden lg:block'>
                <h4 className="text-[20px] font-bold text-[#41463B] mb-3">
                  Non toxic and gentle
                </h4>
          ...
          {/* MODIFIED: Removed mt-10 and added a padding-top and top border for separation */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 pt-10 border-t border-[#EDECE7]"> 
             {/* Image: Using fixed height for better visual control on large screens */}
             <div className="relative w-full h-64 md:h-80 lg:h-[300px] rounded-lg overflow-hidden shadow-lg">
                <img
                  src={IMAGE_HAND}
              ...
              {/* Used worldwide / Non toxic and gentle (Content is visually placed on the right column next to the second image in the original image layout) */}
              <div className="space-y-10 flex flex-col justify-end">
                {/* Used worldwide - Re-enabled for this section on large screens to match the final visual layout */}
                <div className='block'>
                  <h4 className="text-[20px] font-bold text-[#41463B] mb-3">
                    Used worldwide
                  </h4>
                ...
                {/* Non toxic and gentle - Re-enabled for this section on large screens to match the final visual layout */}
                <div className='block'>
                  <h4 className="text-[20px] font-bold text-[#41463B] mb-3">
                    Non toxic and gentle
                  </h4>
