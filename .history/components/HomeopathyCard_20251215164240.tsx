      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="bg-white p-6 md:p-10 lg:p-12 shadow-xl rounded-lg border border-[#EDECE7]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-10">
            {/* Left Column Content - Holds the first three text blocks */}
            <div className="space-y-10 order-2 lg:order-1">
              ...
              <div>
                ...
                <p className="text-[#41433B] text-base">
            ...
            <div className="space-y-10 order-1 lg:order-2">
              ...
              {/* Top Image: Adjusted for a tall rectangular look on desktop to match the layout mockups */}
              {/* Using a fixed height that looks appropriate for the surrounding text height */}
              <div className="relative w-full h-64 md:h-80 lg:h-[420px] rounded-lg overflow-hidden shadow-lg">
                <img
                  src={IMAGE_REMEDIES}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mt-10">
             {/* Image: Adjusted for a more horizontal look relative to the text on desktop */}
             {/* Note: I removed the aspect ratio classes that require a plugin and used a fixed height */}
             <div className="relative w-full h-64 sm:h-80 lg:h-[250px] rounded-lg overflow-hidden shadow-lg">
                <img
                  src={IMAGE_HAND}
              ...
              <div className="flex flex-col justify-end">
                 {/* This text is intentionally hidden as per the original component's logic, leaving the right column blank for this row. */}
                 <h4 className="text-[20px] font-bold text-[#41463B] mb-3 hidden">
                   Image Placeholder Text
                 </h4>
                 <p className="text-[#41433B] text-base italic hidden">
