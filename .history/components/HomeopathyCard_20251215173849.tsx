...
// Body emphasis text (used for “Homeopathy is built on a few key ideas”)
const BODY_LABEL =
  "font-montserrat text-base font-semibold leading-7 text-[#0B0C0A]";
