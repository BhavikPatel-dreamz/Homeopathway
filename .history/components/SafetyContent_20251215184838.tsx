...
const SafetyChecklistItem: React.FC<SafetyChecklistItemProps> = ({ children }) => (
  <div className="flex items-start gap-2">
    {/* REPLACED THE SINGLE '✓' WITH A TEXT-BASED DOUBLE-CHECK SYMBOL (or a symbol that visually simulates it) to align with 'check-double-fill' request. */}
    {/* Using a visually similar unicode/text to represent the "check-double-fill" style without importing the library. */}
    {/* The unicode for a double checkmark is ' डबल-टिक ' (or similar text symbol). A simple text approach is two checks: */}
