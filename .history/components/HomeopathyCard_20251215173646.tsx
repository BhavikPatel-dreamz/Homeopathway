...
// 2. Main Title (What is Homeopathy?) (Primary, Regular, h3)
const MAIN_TITLE_STYLE = "font-sans text-3xl md:text-4xl lg:text-[40px] font-normal text-[#0B0C0A]";

// 3. Sub-Headings (A historical foundation, etc.) (Secondary, SemiBold, body-lg)
const SUB_HEADING_STYLE = "font-montserrat text-xl font-semibold leading-7 text-[#0B0C0A]";

// 4. Section Intro Text ("Homeopathy is built on a few key ideas:") 
//    This should be a sub-style of SUB_HEADING_STYLE, likely slightly smaller or less bold.
const SECTION_INTRO_STYLE = "font-montserrat text-[22px] md:text-xl font-semibold leading-7 text-[#0B0C0A]"; // Slightly adjusted size for visual difference
        ...
        <section className="bg-[#F5F1E8] py-10 md:py-16">
            <div className="max-w-[1200px] mx-auto px-4 md:px-6">
                <div className="bg-white rounded-[16px] border border-[#EDECE7] p-6 md:p-10 lg:p-12 shadow-md">
                    ...
                    {/* H2 - "Homeopathy is built on a few key ideas" - Applying new SECTION_INTRO_STYLE */}
                    <h2 className={`${SECTION_INTRO_STYLE} mb-8`}>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-10 items-start">
                        ...
                        <div className="space-y-10 lg:order-1 order-2">
                            ...
                            {/* A historical foundation - Uses ContentBlock which uses SUB_HEADING_STYLE */}
                            ...
                            {/* Based on natural sources - Uses ContentBlock which uses SUB_HEADING_STYLE */}
                    ...
                    {/* ===== SECTION 2: Potentization (Must be below Image 1 in flow) ===== */}
                    <div className="mt-10">
                        {/* Potentization - Uses ContentBlock which uses SUB_HEADING_STYLE */}
                    ...
                    {/* ===== SECTION 3: Image 2, Used worldwide, Non toxic and gentle ===== */}
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-10 mt-12 items-start">
                        ...
                        <div className="space-y-10">
                            {/* Used worldwide - Uses ContentBlock which uses SUB_HEADING_STYLE */}
                            ...
                            {/* Non toxic and gentle - Uses ContentBlock which uses SUB_HEADING_STYLE */}
                    ...
                    <div className="border-t border-[#EDECE7] mt-12 pt-10">
                        {/* Footer Title - Updated font style */}
