...
// Using a utility component for consistent structure and easy reading
const SUB_TITLE = "font-montserrat text-xl font-semibold leading-7 text-[#0B0C0A]";
        ...
        <section className="bg-[#F5F1E8] py-10 md:py-16">
            <div className="max-w-[1200px] mx-auto px-4 md:px-6">
                <div className="bg-white rounded-[16px] border border-[#EDECE7] p-6 md:p-10 lg:p-12 shadow-md">
                    ...
                    {/* PAGE TITLE */}
                    <h1 className="font-sans text-3xl md:text-4xl lg:text-[40px] font-bold text-[#0B0C0A] mb-4">
                        What is Homeopathy?
                    </h1>
                    ...
                    <h2 className={`${SUB_TITLE} mb-8`}>
                        Homeopathy is built on a few key ideas:
                    </h2>

                    {/* ===== MAIN TWO-COLUMN LAYOUT (Historical foundation, Natural sources, Potentization & Image 1) ===== */}
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-10 items-start">
                        ...
                        <div className="space-y-10 lg:order-1 order-2">
                            ...
                            {/* Potentization (This block needs to be placed here for the visual flow) */}
                            {/* In the image, this block sits just below the text blocks on the left, but above the second image row. */}
                    ...
                    {/* ===== ROW 2 (Image 2, Used worldwide, Non toxic) ===== */}
                    {/* Use a new two-column grid starting below the first section */}
                    ...
                    <div className="border-t border-[#EDECE7] mt-12 pt-10">
                        <h2 className="font-sans text-3xl md:text-4xl lg:text-[40px] font-bold text-[#0B0C0A] mb-4">
