...
const SafetyContent = () => {
  return (
    <div className="bg-white p-6 shadow-lg rounded-lg max-w-7xl mx-auto my-8 border border-gray-200">
      ...
      {/* The top "Safety and Research" heading is removed here 
        because it is already present in the parent page.tsx component's header.
        We only keep the introductory text.
      */}
