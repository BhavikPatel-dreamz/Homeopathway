// components/HomeopathyCard.js
import React from 'react';

// Use placeholder image URLs. Replace them with your actual image paths.
const IMAGE_REMEDIES = "/placeholder-remedies.jpg"; // Corresponds to the image on the right
const IMAGE_HAND = "/placeholder-hand.jpg";     // Corresponds to the image of the hand holding the bottle

export default function HomeopathyCard() {
  return (
        ...
        <div className="bg-white p-6 md:p-10 lg:p-12 shadow-xl rounded-lg border border-[#EDECE7]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-10">
            ...
            <div className="space-y-10 order-2 lg:order-1">
              ...
              {/* Used worldwide / Non toxic and gentle - Grouped for layout matching the image */}
              <div className='lg:hidden'>
                {/* Used worldwide - Visible on smaller screens where it doesn't align next to the image */}
                <h4 className="text-[20px] font-bold text-[#41463B] mb-3">
                  Used worldwide
                </h4>
                <p className="text-[#41463B] text-base">
              ...
              <div className='lg:hidden'>
                {/* Non toxic and gentle - Visible on smaller screens where it doesn't align next to the image */}
                <h4 className="text-[20px] font-bold text-[#41463B] mb-3">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mt-10">
             ...
             <div className="aspect-w-16 aspect-h-9 sm:aspect-h-7 lg:aspect-h-9 rounded-lg overflow-hidden shadow-lg">
              ...
              {/* Used worldwide / Non toxic and gentle (These blocks were moved/repositioned in the provided image layout. For the final matching layout, I've kept them in the main two-column grid. I will keep this section for the bottom "Why HomeoPathway Exists" section's introductory text to match the flow.) */}
