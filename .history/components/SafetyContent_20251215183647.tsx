...
// 1. Define the props interface for SafetyChecklistItem to correctly type 'children'
interface SafetyChecklistItemProps {
  children: ReactNode; // ReactNode covers strings, numbers, elements, and arrays of these
}

// Utility component for the checklist items in "Safety Considerations"
// We use React.FC (Function Component) and pass the interface to correctly type the props.
...
const SafetyContent = () => {
  return (
    <div className="bg-white p-6 shadow-lg rounded-lg max-w-7xl mx-auto my-8 border border-gray-200">
      ...
      {/* The redundant "Safety and Research" heading (which was an <h1>) 
        has been REMOVED here to prevent duplication with the main page header.
        The content now starts with the introductory paragraph, styled with a border-bottom 
        to separate it from the rest of the card content, mimicking the original layout's divider.
      */}
      <p className="text-lg text-gray-700 mb-8 border-b pb-4">
